  ...
  const facilities = [
    {
      ...
      description: "Fasilitas pendidikan berkualitas untuk anak-anak dukuh",
    },
    {
      icon: "🕌",
      title: "Masjid",
      description: "Tempat ibadah bagi warga dukuh",
    },
    {
      icon: "🛣️",
      title: "Jalan Aspal",
      description: "Infrastruktur jalan yang baik menghubungkan seluruh dukuh",
    },
    {
      icon: "🌾",
