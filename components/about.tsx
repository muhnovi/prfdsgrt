    ...
    >
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl font-bold text-foreground mb-4">Tentang Dukuh Garotan</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
          ...
          <div className="space-y-6">
            ...
            <p className="text-muted-foreground leading-relaxed">
              Dukuh Garotan terkenal dengan pertanian, peternakan, dan kehangatan gotong
            ...
            <ul className="space-y-3 text-muted-foreground">
              ...
              <li className="flex items-center gap-3">
                <span className="text-primary font-bold">✓</span> Peternakan
              </li>
              <li className="flex items-center gap-3">
